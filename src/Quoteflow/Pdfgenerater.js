...
import { View, Button, Text, Linking, StyleSheet,TouchableOpacity ,RefreshControl,ScrollView} from 'react-native';
...
const Quotegenerator = ({route}) => {
  //  const{item}=route.params;
  const item={Budget: "300000", Clientname: "Suresh ", Initialamount: "100000", Projectname: "Residential", Projectstatus: "Finishing ", SiteLocation: "Gtn", key: "-NoM6NpNc-YTeHa3RyPR"};
  const pdfRef = useRef();
...
const ref = database().ref('Construction').child('ProjectView').child('AdditionalforQuotation');
useEffect(() => {
...
useEffect(()=>{
       logojpg()
    const dataRef = database().ref('Construction').child('ProjectView').child('Quotation');
    console.log(dataRef)
...
const IndianFormatter = new Intl.NumberFormat("en-IN");  
  ...
  const formatNumberWithCommas = (number) => {
    ...
    const integerPart = parts[0].replace(/\B(?=(\d{2})+(?=(\d{3})+(?!\d)))/g, ',');
    const formattedNumber = parts.length === 1 ? integerPart : `${integerPart}.${parts[1]}`;
...
<body>
    ...
    <div>
        ...
        <img src="${logourl}" alt="Trulli" width="100" height="100">
        </div>
    </header>
...
<div class="contentrow">
    <div class="contentrowleft">
       <p>Cement for all purposes:</p>
       </div>
       <div class="contentright">
   <p>${Data.Cementbrand} </p>
</div>
</div>
<div class="contentrow">
    <div class="contentrowleft">
       ...
       <div class="contentright">
   <p>${Data.WhiteCementbrand}</p>
</div>
</div>
<div class="contentrow">
    <div class="contentrowleft">
       <p>Reinforcement steel:</p>
       </div>
       <div class="contentright">
   <p>${Data.Steelbrand} </p>
</div>
...
<div class="contentrow">
    <div class="contentrowleft">
       ...
       <div class="contentright">
   <p>Rs. ${Data.MaindoorRate}/- (lock, tower bolt, handles, aldrop, hinges)</p>
</div>
</div>
<div class="contentrow">
    <div class="contentrowleft">
       ...
       <div class="contentright">
   <p>Rs. ${Data.OtherdoorRate}/- (lock, tower bolt, handles, aldrop, hinges)</p>
</div>
</div>
<div class="contentrow">
    <div class="contentrowleft">
       ...
       <div class="contentright">
   <p>Rs. ${Data.ToiletdoorRate}/- (lock, tower bolt, handles, aldrop, hinges)</p>
</div>
</div>
<div class="contentrow">
    <div class="contentrowleft">
       ...
       <div class="contentright">
   <p>Rs. ${Data.WindowRate}/- (lock, bolt, handles, friction stay, hinges)</p>
</div>
</div>
<div class="contentrow">
    <div class="contentrowleft">
...
<div class="contentrow">
    <div class="contentrowleft">
       <p>Indian Glass set :</p>
       </div>
       <div class="contentright">
   <p>Rs. ${Data.Indianglasssetrate}/-</p>
</div>
</div>
<div class="contentrow">
    <div class="contentrowleft">
...
<div class="contentrow">
    <div class="contentrowleft">
       ...
       <div class="contentright">
   <p>Rs. ${Data.Floortilerate}/- per sft</p>
</div>
</div>
<div class="contentrow">
    <div class="contentrowleft">
       <p>Wall tiles(Kitchen)  :</p>
       </div>
       <div class="contentright">
   <p>Rs. ${Data.Kitchentilerate}/- per sft</p>
</div>
</div>
<div class="contentrow">
    <div class="contentrowleft">
       <p>Bathroom tiles(Kitchen)  :</p>
       </div>
       <div class="contentright">
   <p>Rs. ${Data.bathroomtilerate}/- per sft</p>
</div>
</div>
<div class="contentrow">
    <div class="contentrowleft">
       ...
       <div class="contentright">
   <p>Rs. ${Data.Graniterate}/- per sft</p>
</div>
</div>
...
<div class="contentrow">
    <div class="contentrowleft">
       ...
       <div class="contentright">
   <p>Rs. ${Data.IndianWaterclosetRate}/- per piece including ‘S’ trap</p>
</div>
</div>
...
<div class="contentrow">
    <div class="contentrowleft">
       ...
       <div class="contentright">
   <p>Rs. ${Data.EuropeanWaterclosetRate}/set (S/P trap, flush tank, seat cover)</p>
</div>
</div>
<div class="contentrow">
    <div class="contentrowleft">
       ...
       <div class="contentright">
   <p>Rs. ${Data.WashbasinRate}/- including basin, SS bottle trap, full / half thread coupling, clamps, expansion fasteners, hot water hose and all other related accessories but excluding tap </p>
</div>
</div>
<h3>GENERAL TERMS </h3>
<ul>
            ...
            <table>
                ...
                ${Data1.map(data=>`
                    <tr>
                        ...
                        <td>${data.Quantity}</td>
                        <td>${data.Rate}</td>
                        <td>${IndianFormatter.format(data.Amount)}</td>
                    ...
                    <td></td>
                    <td></td>
                    <td>${IndianFormatter.format(tAmount)}</td>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>${IndianFormatter.format(AdditionalWork.UnderGroundSumpAmount)}</td>
                    ...
                    <tr>
                        ...
                        <td>${IndianFormatter.format(AdditionalWork.OverHeadTankAmount)}</td>
                    </tr>
                    <tr>
                        <td>3</td>
                        <td>Septic tank  </td>
                        ...
                        <td>${IndianFormatter.format(AdditionalWork.SepticTankAmount)}</td>
                    </tr>
                    ...
                    <td></td>
                    <td></td>
                    <td>${IndianFormatter.format(AdditionalWork.SepticTankAmount+AdditionalWork.OverHeadTankAmount+AdditionalWork.UnderGroundSumpAmount)}</td>
                    </tr>
                    <tr>
                    <td></td>
                    ...
                    <td></td>
                    <td></td>
                    <td>${IndianFormatter.format(AdditionalWork.SepticTankAmount+AdditionalWork.OverHeadTankAmount+AdditionalWork.UnderGroundSumpAmount+tAmount)}</td>
                    </tr>
