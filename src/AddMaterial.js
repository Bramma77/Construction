...
const[FloorName,setFloorName]=useState("");
  ...
  const reference = database().ref('Construction').child('ProjectView').child('Quote');
...
const slectbrandfalse=()=>{
  ...
  const onEditData=()=>{
    ...
    onChangeFloortilebrand(data.Floortilebrand)
     ...
     onChangegranitetilerate(data.Granitetilerate)
...
const renderItem14=({item,index})=>{
    ...
    const isSelected = SelectedSeptictankbrand?.filter((i) => i === item.Brand ).length > 0;
    return(
    <View style={{marginVertical:10}}>
        <View style={{flexDirection:'row',justifyContent:'space-between'}}>
    <TouchableOpacity onPress={()=>{
      if(isSelected){
            setSelectedSeptictankbrand((prev)=>prev.filter((i)=>i!==item.Brand))
        }
        else{
            setSelectedSeptictankbrand((prev)=>[...prev,item.Brand])
        }}}>
        <View style={{flexDirection:'row'}}>
        <View style={{borderWidth:1,width:20,height:20,alignItems:'center',justifyContent:'center'}}>
          {isSelected? (<Octicons style={{ color:'green',  position: 'absolute' }} name='check' size={20} />):null}
       ...
       <View style={[{backgroundColor:'#ff9900',borderRadius:10}]}>
        ...
        <View style={[{backgroundColor:'#ff9900',borderRadius:10}]}>
         ...
         <Text style={{color:'white',fontSize:14,padding:10}}>Add Brand</Text>
            ...
            <View style={Styles.ItemView} >
            <Text style={Styles.Label}>Water (Tank or Sump) Brand:</Text>
            <TouchableOpacity onPress={()=>{setselectbrand(true)
            setisWaterbrand(true)
            }} style={{flex:1}} >
            <TextInput
                style={Styles.TextInput}
                onChangeText={onChangewatertankbrand}
                textAlign="center"
                multiline={true}
                editable={false}
        ...
        <View style={Styles.ItemView} >
            ...
            <TextInput
                ...
                keyboardType='number-pad'
                textAlign="center"
                onChangeText={onChangewatertankrate}
                value={watertankrate}
            />
        </View>
        </ImageBackground>
        ...
        <View style={[{backgroundColor:'#ff9900',borderRadius:10}]}>
         ...
         <Text style={{color:'white',fontSize:14,padding:10}}>Add Brand</Text>
            ...
            <View style={Styles.ItemView} >
            <Text style={Styles.Label}>Septic Tank:</Text>
            <TouchableOpacity onPress={()=>{setselectbrand(true)
            setisSepticbrand(true)
            }} style={{flex:1}} >
            <TextInput
                style={Styles.TextInput}
                onChangeText={onChangeseptictankbrand}
                value={septictankbrand}
                multiline={true}
                editable={false}
        ...
        <View style={Styles.ItemView} >
            ...
            <TextInput
                ...
                keyboardType='number-pad'
                textAlign="center"
                onChangeText={onChangeseptictankrate}
